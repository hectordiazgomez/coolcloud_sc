...
const CloudProviderSelector = () => {
    ...
    const generateCloudFormationURL = () => {
        const templateURL = ""
        const region = '';
        const baseCFNURL = ``;
        const stackURL = `${baseCFNURL}?region=${region}#/stacks/create/review`;
        const params = {
            templateURL: templateURL,
            stackName: roleName,
            param_InstanceType: "t2.medium",
        };
        return `${stackURL}?${new URLSearchParams(params).toString()}`;
    };
                    ...
                    <div className='pl-12'>
                        ...
                        <div className='flex pt-6'>
                            <a className='flex items-center'
                                href={generateCloudFormationURL()}
                                target='_blank'
